...
class PotokenExtractor:
    ...
    @staticmethod
    def _extract_token(request: zd.cdp.network.Request) -> Optional[TokenInfo]:
    ...
    async def _perform_update(self) -> None:
        ...
        async with self._ongoing_update:
            ...
            tab.add_handler(zd.cdp.network.RequestWillBeSent, self._send_handler)
    ...
    @staticmethod
    async def _click_on_player(tab: zd.Tab) -> bool:
        try:
    ...
    async def _send_handler(self, event: zd.cdp.network.RequestWillBeSent) -> None:
